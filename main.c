...
_kernel_oserror *module_service (int service, _kernel_swi_regs *r, void *pw) {
	switch (service) {
		...
		case 7: /* DrawTriangle */
		{
			...
			point_2d v1;
			point_2d v2;
			v0.x = r->r[0]; v0.y = r->r[1];
			v1.x = r->r[2]; v1.y = r->r[3];
			v2.x = r->r[4]; v2.y = r->r[5];
